<template>
    <div class="plan-section" v-show="plans.length">
        <div class="container-lg">
            <h2>学习计划</h2>
            <div class="card-list">
              <div class="card-item"  v-for="(plan, index ) in plans"  v-if="index < showLength">
            ...
            <div class="more-plan">
              <a v-if="showLength !== plans.length"  @click="showMorePlan" href="javascript:;">查看全部纳米学位项目<span class="icon__arrow--white"></span></a>
            </div>
        </div>
    </div>
</template>
...
export default {
  ...
  methods: {
    showMorePlan: function() {
      this.showLength = this.plans.length
    }
  }
}
</script>
